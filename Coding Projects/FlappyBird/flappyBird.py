...
class App(Frame):
    def __init__(self, master):
        ...
        #infile = open('high.txt','r') Eventually
        self.high = Label(text="High Score: X", font=("Arial",24))
        self.high.grid(row=0,column=1, sticky='news')
        #Now, the mechanics of this button will be coded... soon.
    ...
    def main_game(self):
        ...
        for pillar in self.pillars:
            pillar.move()
            if pillar.xLoc < 202 and pillar.xLoc > 197:
                self.score += 1
